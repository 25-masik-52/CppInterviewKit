#### **1. Определение**
**Декоратор** — это структурный паттерн, который позволяет **динамически добавлять** новые функциональные возможности объектам, оборачивая их в специальные классы-декораторы. Это более гибкая альтернатива классическому наследованию.
