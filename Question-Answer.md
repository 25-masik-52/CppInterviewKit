...
collapse: closed
![[algorithms_22_median_in_numbers_stream]]
```
...
collapse: closed
![[algorithms_29_the_power_of_two]]
```

```ad-algorithms
title: Как перевернуть строку in-place без дополнительной памяти?
collapse: closed
![[algorithms_30_flip_the_line_in_place]]
```
...
collapse: closed
![[algorithms_31_backpack_&_largest_increasing_subsequence]]
```
