...
collapse: closed
![[Расскажи о проектах и технологиях, с которыми работал.]]
```

```ad-about
title: Что ты делал, что не входило в твои прямые обязанности. 🔥
collapse: closed
![[Что ты делал, что не входило в твои прямые обязанности.]]
```

```ad-about
title: Какой проект был самым сложным в твоей карьере и почему?
collapse: closed
![[Какой проект был самым сложным в твоей карьере и почему?]]
```

```ad-about
title: Как ты подходишь к рефакторингу legacy-кода? 🔥
collapse: closed
![[Как ты подходишь к рефакторингу legacy-кода?]] 
```

```ad-about
title: Какие методологии разработки (Agile, Scrum, Kanban) ты использовал на практике?
collapse: closed
![[Какие методологии разработки (Agile, Scrum, Kanban) ты использовал на практике?]]
```
